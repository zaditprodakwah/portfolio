...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: getCanonicalUrl("/intelligence/"),
  },
  openGraph: {
    title: "Intelijen Data Lapangan & Sentinel Pasar | PRADIKTIF Data Lab",
    description: "Mengubah telemetri lapangan menjadi keunggulan keputusan sebelum laporan publik terbit. Solusi 7 vertikal industri terverifikasi.",
    url: getCanonicalUrl("/intelligence/"),
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "item": getCanonicalUrl("/intelligence/")
          }
        ]
      },
      {

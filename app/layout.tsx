...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body className="min-h-screen w-full max-w-full overflow-x-hidden bg-alabaster text-slate-900 font-sans antialiased selection:bg-teal-700 selection:text-white">
        {children}
      </body>
    </html>
  );

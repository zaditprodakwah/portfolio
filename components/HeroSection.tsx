...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenChat }) => {
  ...
  return (
    <section id="hero" className="pt-24 sm:pt-28 pb-10 sm:pb-16 px-4 sm:px-6 max-w-6xl mx-auto flex flex-col justify-center">
      {/* Floating Non-Intrusive Greeting Capsule */}
      <PersonalGreetingCapsule lang={lang} onOpenChat={onOpenChat} />
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-3xl sm:text-5xl font-heading font-extrabold tracking-tight text-slate-900 leading-[1.18]">
              {lang === "id" ? (
                <>
                  Solusi Praktis & Presisi untuk <br className="hidden sm:inline" />

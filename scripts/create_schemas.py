...
os.makedirs("/Users/mac/Documents/AGENTS_WORK_HUB/apps/zadit-pages/scripts/schema", exist_ok=True)

direktori_schema = """import { z } from "zod";
...
with open("/Users/mac/Documents/AGENTS_WORK_HUB/apps/zadit-pages/scripts/schema/direktori.ts", "w") as f:
    f.write(direktori_schema)

print("Created scripts/schema/direktori.ts")
